...
export class LaboratoryController {
  ...
  @ApiOperation({
    description: 'Traer laboratorios',
    summary: 'Encontrar laboratorios',
  })
  @Get()
  ...
  @ApiOperation({
    description: 'Traer laboratorio',
    summary: 'Encontrar laboratorio',
  })
  @Get(':id')
  ...
  @ApiOperation({
    description: 'Crear Laboratoryio',
  ...
  async update(
    ...
    const response = await this.laboratoryService.update(
      id,
      updateLaboratoryDto,
    );
    return response;
  ...
  @ApiOperation({
    description: 'Actualizado parcial',
    summary: 'Actualizar laboratorio',
  })
  @Patch(':id')
  changeState(
